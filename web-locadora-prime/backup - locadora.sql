...
CREATE DATABASE IF NOT EXISTS `dtb-locadora-rich` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Copiando dados para a tabela dtb-locadora-rich.cliente: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela dtb-locadora-rich.contato: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela dtb-locadora-rich.endereco: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela dtb-locadora-rich.filme: ~7 rows (aproximadamente)
...
INSERT INTO `filme` (`id_filme`, `nome`, `valor`, `disponivel`, `promocao`, `valor_promocao`, `diretor`, `ano_lancamento`, `faixa_etaria`, `genero`) VALUES
	...
	(3, 'O Poderoso Chefão', 16, 'Não', 'Sim', 13.65, 'Luiz Hermanem', '1980', 18, 'Ação'),
...
-- Copiando dados para a tabela dtb-locadora-rich.forma_pagamento: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela dtb-locadora-rich.funcionario: ~3 rows (aproximadamente)
...
INSERT INTO `locacao` (`id_locacao`, `data_locacao`, `data_devolucao`, `valor`, `devolvido`, `funcionario_id_funcionario`, `forma_pagamento_id_forma_pagamento`, `cliente_id_cliente`) VALUES
	(1, '07/04/2021', '07/05/2021', 13.65, 'Não', 2, 2, 1);
...
INSERT INTO `locacao_filme` (`id_locacao_filme`, `filme_id_filme`, `locacao_id_locacao`) VALUES
	(1, 3, 1);
